  ...
  kormushki: [
    {
      ...
      basePrice: 1000,
      description:
        'Оригинальная кормушка для птиц, выполненная в виде сказочной избушки',
      pageDescription: [
  ...
  'aksessuary-i-drugoe': [
    {
      ...
      basePrice: 1000,
      description:
        'Малая, но очень уютная кормушка, выполненная из натурального кокоса. Идеально подойдёт для мелких садовых птиц.',
      pageDescription: [
  ...
  grains: [
    {
      ...
      relatedBirds: [
        ...
        { id: 5, name: 'Ворона серая', image: vorona },
        { id: 4, name: 'Дятел пёстрый', image: woody },
        { id: 6, name: 'Снегриь', image: snegir },
        { id: 9, name: 'Скворец', image: skvorec },
        { id: 10, name: 'Ласточка', image: lastochka },
      ],
      relatedMixes: [
